...
<head runat="server">
    ...
    <script src="Operations_History_Controller.js"></script>
...
<body data-ng-controller="AIR_REFUNDController" class="theme-default main-menu-animated">
...
<%--    <script>
    ...
    <div class="alert alert-info" ng-show="false">
        ...
        This control will list subscribers in which got a refund more than deduction while using VAS,
        and international balance transfers.
    </div>
    ...
    <form id='input-form' class="panel form-horizontal">
        <div class="panel-body">
            <div class="row form-group">
                ...
                <div class="col-sm-10">
                    <select id="ORIGINHOSTNAME" name="ORIGINHOSTNAME" class="ORIGINHOSTNAME">
    ...
    <!---------------------------------------------Charts------------------------------------------------->
    <div id="TAPINChart" style="height: 400px;" ng-show="flag"></div>
    <div id="BILLINGChart" style="height: 400px;" ng-show="flag"></div>
    ...
    <div class="row" ng-show="!flag" style="margin-left: 15px">
            ...
            <table class="table table-bordered" id="myTable01">
                <thead>
                    <tr>
                        ...
                        <th>Measure From</th>
                        <th>Measure To</th>
                        <th>Total Number of CDRs</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="gradeU" data-ng-repeat="Row in AIR_Refund_CDRS">
                        <th>{{Row[0]}}</th>
                        <th>{{Row[1]}}</th>
                        <th>{{Row[2]}}</th>
        ...
        <div class="table-footer">
            <p class="text-center text-success" data-ng-show="AIR_Refund_CDRS.length == 0">No Data Found</p>
            <pagination total-items="TotalItemsCount" ng-model="CurrentPage" max-size="Pages_Max_Size" rotate="false" boundary-links="true"
                items-per-page="RowsPerPage" ng-change="PageChanged()"></pagination>
        </div>
    </div>
